...
public class openAPIController {
	...
	// json 형식으로 지진해일 대피 OpenAPI 활용
		@RequestMapping(value = "tsunamiShelter", produces = "application/json; charset=UTF-8")
		@ResponseBody
		public String tsunamiShelterJSON() throws IOException {
			// 긴급대피장소 장소가 담길 것
	...
	// json 형식으로 계통한계가격 OpenAPI 활용
		@RequestMapping(value = "smpPredict", produces = "application/json; charset=UTF-8")
		@ResponseBody
		public String smpPredictJSON() throws IOException {
