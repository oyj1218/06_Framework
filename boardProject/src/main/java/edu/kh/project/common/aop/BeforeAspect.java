...
public class BeforeAspect {
	...
	// AOP 코딩 순서를 정해줌
	// 지정된 클래스.메소드에 작성된 @Pointcut() 어노테이션의 내용을 타겟으로 함
	@Before("CommonPointcut.ServiceImplPointcut()") // 타겟 수행 전
	public void beforeLog(JoinPoint jp) { // Advice(수행할 코드)

		// 매개변수 JoinPoint : AOP의 부가 기능이 적용된 대상의 객체, 메소드, 파라미터 정보를 얻을 수 있게 해주는 객체

		// 대상 객체의 간단한 클래스명(패키지명 제외) 얻어오기
